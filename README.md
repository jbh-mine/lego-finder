...
- **검색 출처**: brickinside / brickset / namu.wiki / bricksmith / hobbynet / danawa / kream 의 스니펫, 그리고 개별 블로그·리테일러 리스팅의 한국 발매가 언급.
- **보정 내역 (11건)**:
  - 10182 **Cafe Corner**        ₩199,900 → **₩160,000** (brickinside 2007년 발매가 인용)
  - 10211 **Grand Emporium**     ₩199,900 → **₩209,900**
  - 10218 **Pet Shop**           ₩169,900 → **₩209,900**
  - 10224 **Town Hall**          ₩199,900 → **₩249,900** (2012년 3월)
  - 10232 **Palace Cinema**      ₩169,900 → **₩209,900** (2013년 3월)
  - 10243 **Parisian Restaurant** ₩199,900 → **₩209,900** (2014년 1월)
  - 10246 **Detective's Office** ₩219,900 → **₩229,900** (2015년 4월)
  - 10251 **Brick Bank**         ₩219,900 → **₩209,900** (2016년 1월)
  - 10260 **Downtown Diner**     ₩219,900 → **₩239,900** (2018년 1월)
  - 10264 **Corner Garage**      ₩269,900 → **₩279,900** (2019년 1월)
  - 10278 **Police Station**     ₩269,900 → **₩239,900** (2021년 1월)
- **10197 Fire Brigade 유지**: 모든 검색 결과가 현재 리테일가(₩49만대) 나 USD MSRP($149.99) 만 반환하고 2009년 한국 발매가 원화 수치가 확인되지 않아, 기존 값 ₩199,900 을 보존하고 후속 조사 대상으로 남김.
- **방법론 원칙 재확인**: 검색 스니펫에서 KRW 수치가 직접 언급된 경우만 수정. 추정/환산/USD 기반 재계산은 하지 않음 (21341 사건의 no-fabrication 원칙 계속 적용).
- **결과**: PPP / 희소가치 / 검색 페이지의 단종 모듈러 분석이 검색 검증된 historical KRW 기준으로 수렴. 모듈러 12개 중 11개가 신뢰 가능한 소스에 기반한 값으로 교체되었고, Cafe Corner 의 ₩160,000 (크리에이터 엑스퍼트 라인의 최초 모듈러, 상대적으로 저렴) 가 부품 수 2,056개 기준 PPP 에서 두드러지게 좋은 가성비 순위에 반영됨.
